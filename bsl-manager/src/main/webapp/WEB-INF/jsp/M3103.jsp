...
<div>
	<div class="easyui-panel" title="委外仓产成品库存台账信息查询" style="padding:10px 10px 10px 10px">
	 ...
	 <table class="easyui-datagrid" id="prodWxInfoList" title="委外仓产成品库存台账信息管理"  style="height:600px"
...
<script>
    ...
    var toolbarM3103 = [{
        ...
        handler : function() {
			...
			mapParam.set("excelName","委外仓产成品库存台账信息");
