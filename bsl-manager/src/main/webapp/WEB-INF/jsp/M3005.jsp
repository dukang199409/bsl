...
<div>
	...
	<div id="prodAddWindowB" class="easyui-window" title="产品补录入库" data-options="modal:true,closed:true,iconCls:'edit_add',href:'/prodManager/M3005-addb'" style="width:780px;height:360px;padding:10px;">
	</div>
</div>
<script>
