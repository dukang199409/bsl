...
<div>
	<div class="easyui-panel" title="用料制造信息查询" style="padding:10px 10px 10px 10px">
	 ...
	 <table class="easyui-datagrid" id="semiMakeM3006List" title="用料制造信息"  style="height:600px"
